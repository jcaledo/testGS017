...
vignette: >
  %\VignetteIndexEntry{Orthology_beyond_GS}
...
The MyRec.xml file returned by `ranger_to_recXML.py` can now be visualized using the program `thirdkind`, a nice utility for drawing renconciled phylogenetic trees, which can be reached at https://github.com/simonpenel/thirdkind. Again the code show below is for guidance only.
